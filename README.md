...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Monaspace+Krypton&weight=600&size=45&duration=2000&pause=100&color=8FBCBB&center=true&vCenter=true&repeat=false&random=true&width=500&height=150&lines=Nord-palette+dotfiles+for+Arch)](https://git.io/typing-svg)
...
```bash
# Clone the repo
git clone https://github.com/TheDocingEast/NaviOS-dotfiles.git ~/.dotfiles
cd ~/NaviOS-dotfiles
...
```
NaviOS-dotfiles/
├── .config/          # XDG config (hyprland, quickshell, kitty, nvim, ...)
